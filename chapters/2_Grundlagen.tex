...
Bei einem Komplexen Datenmodell mit Entities und Value Objects, welches von mehreren Nutzern benutzt wird, kann sehr schwierig sein die Konsistenz von Änderungen zu gewährleisten \cite{DDD:Evans:2003}. Daher werden im Domain-Driven Design Entities und Value Objects einer Domain zusammengefasst. Diese Sammlungen von Entities und Value Objects heißen Aggregates.
...
Damit Objekte nicht immer alle Referenzen von benötigten Objekten speichern muss, wird im Domain-Driven Design auf Repositories zurückgegriffen. Sie simulieren eine Sammlung aller Objekte des Typs der Aggregate Root \cite{DDD:Evans:2014, DDD:Plod:2019}. Tatsächlich bezieht das Repository die Objekte aus der Datenbank und rekonstruiert diese. 

Ein Repository unterscheidet von einer Factory, beim Rekonstruieren eines Objekts, darin, dass keine neue Identität erzeugt werden muss \cite{DDD:Avram:2007}. Zudem verfügt ein Repository über Schnittstellen zum Hinzufügen und Löschen von Objekten \cite{DDD:Evans:2014, DDD:Plod:2019}.

\subsubsection{Services}
Wenn eine Operation der Domain \glqq nicht in der natürlichen Verantwortung einer Entity oder eines Value Objects liegt \grqq{}\cite{DDD:Plod:2019}, sollte diese Operation in einen Service ausgelagert werden. Der Service bildet dadurch eine Schnittstelle für mehrere Objekte und sollte zustandslos agieren \cite{DDD:Avram:2007}. Der Name des Services sowie der Operation sollte durch die Ubiquitous Language definiert werden \cite{DDD:Evans:2003}.
