...
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{gfx/Simple_Overview.png}
  \caption{Vereinfachter Überblick über die Muster-Sprache von Domain-Driven Design}
  \label{fig:basics:ddd:pattern}
\end{figure}

In der Abbildung \ref{fig:basics:ddd:pattern} \cite{DDD:Plod:2019} sind die Zusammenhänge der einzelnen Komponenten des Domain-Driven Design dargestellt.
