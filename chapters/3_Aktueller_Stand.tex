...
Nicht nur Klassen und Interfaces können mit Domain-Driven Design Annotationen versehen werden. In Listing \ref{lst:related:analyse:jqa:layer} \cite{Related:Mahler:2019} sieht man ein Beispiel wie man ein Package einer Domain Layer zuordnen kann. Hierbei werden alle Klassen innerhalb diese Package der selben Domain zugeordnet. 
