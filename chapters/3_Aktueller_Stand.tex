...
Zum Beispiel kann durch diese Erweiterung die Klasse aus Listing \ref{lst:related:analyse:jqa:aggregate} \cite{Related:Mahler:2019} als Aggregate Root erkannt werden. jQAssistant fügt dem Knoten, in der Neo4j-Graphdatenbank, das Label \texttt{:DDD:Aggregate} hinzu \cite{Related:Mahler:2019}. Dadurch wird eine Analyse der Klasse zu einem späteren Zeitpunkt nicht mehr benötigt. 
...
Für diese Arbeit kann diese Erweiterung allerdings nicht verwendet werden, da es Annotationen benötigt, welche in dem Anwendungszenario dieser Arbeit nicht vorausgesetzt werden.
