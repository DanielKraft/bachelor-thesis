...
\begin{lstlisting}[caption={Klasse Produkt mit einer Aggregate Root Annotation},captionpos=b,label=lst:jQA-DDD:artifact]
@AggregateRoot
...
\begin{lstlisting}[caption={Zuordnung eines Packages zu der Domain Layer mit einer Annotation},captionpos=b,label=lst:jQA-DDD:layer]
@DomainLayer
