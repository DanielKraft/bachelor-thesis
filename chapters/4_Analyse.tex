...
\begin{lstlisting}[caption={Ausschnitt der Object-Oriented Design Bewertung eines Systems},captionpos=b,label=lst:analyse:metric:ood:output]
"OOD": {
    "distance": {
        "avg": 0.39,
        "min": 0.17,
...
\begin{lstlisting}[caption={Ausschnitt der Domain-Driven Design Bewertung eines Systems},captionpos=b,label=lst:analyse:metric:ddd:output]
"DDD": {
    "artifact": {
