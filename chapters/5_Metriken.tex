...
\begin{equation}
    \text{Totale Kriterien} = \sum \limits_{k \in Kriterien} Relevanz(k) \label{align:analyse:metric:ddd:total}
\end{equation}
...
\begin{equation}
    \text{Erfüllte Kriterien} = \sum \limits_{k \in Kriterien} Relevanz(k)\text{ falls }k\text{ erfüllt} \label{align:analyse:metric:ddd:fulfilled}
\end{equation}
