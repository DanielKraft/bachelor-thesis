...
\begin{table}[htbp] 
    ...
    \begin{tabular}{m{0.8\textwidth}c}   \noalign{\hrule height 2pt}
        ...
        Kein Attribut für eigenen Identität                                 & \texttt{BLOCKER}  \\ 
        Methoden \texttt{equals()} und \texttt{hashCode()}                  & \texttt{MAJOR}    \\
        Getter für jedes Attribut                                           & \texttt{MINOR}    \\ 
...
\begin{lstlisting}[float, caption={Ausschnitt der Domain-Driven Design Bewertung eines Systems},captionpos=b,label=lst:analyse:metric:ddd:output, language=my_json]
"DDD": {
    "artifact": {
