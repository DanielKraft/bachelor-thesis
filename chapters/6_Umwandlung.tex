...
Die \autoref{fig:suggestion:impl:refactor:insert:baseentity} zeigt Ausschnitte der \autoref{fig:anhang:petclinic:old} und der \autoref{fig:anhang:petclinic:new:domain:model}. Die Entity in \autoref{fig:suggestion:impl:refactor:insert:baseentity:old} besitzt ein Attribut welches die Identität der Entity repräsentiert, allerdings wurde dieses Attribut als \texttt{Integer} realisiert. Daher wurde dieses Attribut vom Umwandlungsalgorithmus als Value Object ausgelagert. 
