...
Die Abbildung \ref{fig:discuss:adm:ddd} zeigt, dass auch dieses System einen deutlichen Zuwachs an Value Objects erfahren hat. Da das ursprüngliche System aus verhältnismäßig wenigen Artefakten bestand, nahm die Anzahl von Modulen nicht so deutlich zu wie im vorherigen Beispiel.
...
Das erste Szenario kann auftreten, wenn der Umwandlungsalgorithmus Attribute von Entities als Value Object auslagert. Dabei kann es passieren, dass Attribute welche zusammengehören, in mehrere Value Objects aufgeteilt werden.
