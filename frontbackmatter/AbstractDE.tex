...
\begin{otherlanguage}{ngerman}
    ...
    Zurzeit wird das Domain-Driven Design gerne in der Softwareentwicklung verwendet. Aber nicht in allen Systemen werden alle Standards des Domain-Driven Design eingehalten, obwohl das Domain-Driven Design dabei helfen kann die Qualität des Quellcodes zu verbessern. Das Domain-Driven Design kann zum Beispiel die Modularität und die Lesbarkeit des Quellcodes erhöhen.
